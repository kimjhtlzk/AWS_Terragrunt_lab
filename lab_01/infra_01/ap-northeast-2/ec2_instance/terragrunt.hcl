terraform {
  source = "${dirname(find_in_parent_folders())}/modules/ec2_instance/ver_2.0.0"
}
...
inputs = {
  ec2_instance = [
    ...
    #   associate_public_ip_address = dependency.elastic_ip.outputs.eip_id["rnd-eip-1"] # null or eip name
    #   security_groups             = [ 
