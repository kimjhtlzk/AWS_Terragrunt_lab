terraform {
  source = "/Users/hann/hann_lab/terrform_labs/terragrunt_labs/terragrunt_lab/lab_01/module/nat_gateway/ver_1.0.0"
}
...
inputs = {
  ngw = [
    {
      name        = "ngw-rnd-vpc-1"
      eip         = dependency.elastic_ip.outputs.eip_id["rnd-eip-1"]
